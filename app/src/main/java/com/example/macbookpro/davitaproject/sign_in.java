...
public class sign_in extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bb1 = (Button) findViewById(R.id.gofin);
    ...
    class tesfir extends AsyncTask<String, String, Void> {
            ...
            protected Void doInBackground(String... params) {
                String url = " http://www.davitacare.byethost24.com/demo.php";
                ...
                try {
                    ...
                    Toast.makeText(sign_in.this, "Error in http connection", Toast.LENGTH_LONG).show();
                }
                try {
